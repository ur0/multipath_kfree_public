...
- (void)applicationWillTerminate:(UIApplication *)application {
  ...
  // appropriate. See also applicationDidEnterBackground:. Saves changes in the
  // application's managed object context before the application terminates.
  [self saveContext];
}
  ...
  @synchronized(self) {
    if (_persistentContainer == nil) {
      _persistentContainer =
          [[NSPersistentContainer alloc] initWithName:@"XNUFuzzer"];
      [_persistentContainer
